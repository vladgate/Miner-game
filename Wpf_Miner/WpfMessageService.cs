...
namespace Wpf_Miner
{
   internal sealed class WpfMessageService : IMessageService
   {
      ...
      {
         MessageBoxEx.Show(Application.Current.MainWindow, message, caption, MessageBoxButton.OK, MessageBoxImage.Error);
      }
      public void ShowMessage(string message, string caption)
      {
         MessageBoxEx.Show(Application.Current.MainWindow, message, caption, MessageBoxButton.OK, MessageBoxImage.Information);
      }
      public bool WinGame(string text, string caption)
      {
         MessageBoxResult dr = MessageBoxEx.Show(Application.Current.MainWindow, text, caption, MessageBoxButton.YesNo);
   ...
   internal class MessageBoxEx // message box class that can be align to center of the parent window
   {
      ...
      private static void Initialize()
      {
         ...
         if (_owner != null)
         {
            _hHook = SetWindowsHookEx(WH_CALLWNDPROCRET, _hookProc, IntPtr.Zero, GetCurrentWin32ThreadId());
         }
      }
